...
import { setCurrentServiceCategory } from '@/shared/models/service-categories.ts';
    ...
    <section className='px-4 py-2 hover:bg-background-generic'>
      <div className='gap-4 flex-between'>
        <div className='flex w-full items-center gap-2'>
          <div className='bg-purple size-8 rounded-md font-medium text-white flex-center'>
            {id}
          </div>
        ...
        <DropdownMenu
          ...
          items={[
            {
              action: () => setCurrentServiceCategory(el),
